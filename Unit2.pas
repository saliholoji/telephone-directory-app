...
begin
      ...
      begin
           MessageBox(handle, 'Baþarýyla giriþ yapýldý!', 'Baþarýlý!', MB_OK + MB_ICONINFORMATION);
      ...
      if AdoQuery1.RecordCount <=0 then
      begin
      MessageBox(handle, 'Kullanýcý Adý veya Þifreniz yanlýþ', 'Baþarýsýz!', MB_OK + MB_ICONINFORMATION);
      end;
      AdoQuery1.Active := False;
end;
